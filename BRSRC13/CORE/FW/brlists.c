...
CARM95_WEBSERVER_STATE(BrNewList, function_hook_state_BrNewList)
...
CARM95_WEBSERVER_STATE(BrAddHead, function_hook_state_BrAddHead)
...
CARM95_WEBSERVER_STATE(BrAddTail, function_hook_state_BrAddTail)
...
CARM95_WEBSERVER_STATE(BrRemHead, function_hook_state_BrRemHead)
...
CARM95_WEBSERVER_STATE(BrRemTail, function_hook_state_BrRemTail)
...
CARM95_WEBSERVER_STATE(BrInsert, function_hook_state_BrInsert)
...
CARM95_WEBSERVER_STATE(BrRemove, function_hook_state_BrRemove)
...
CARM95_WEBSERVER_STATE(BrSimpleNewList, function_hook_state_BrSimpleNewList)
...
CARM95_WEBSERVER_STATE(BrSimpleAddHead, function_hook_state_BrSimpleAddHead)
...
CARM95_WEBSERVER_STATE(BrSimpleRemHead, function_hook_state_BrSimpleRemHead)
...
CARM95_WEBSERVER_STATE(BrSimpleInsert, function_hook_state_BrSimpleInsert)
...
CARM95_WEBSERVER_STATE(BrSimpleRemove, function_hook_state_BrSimpleRemove)
