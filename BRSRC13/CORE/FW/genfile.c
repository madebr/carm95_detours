...
CARM95_WEBSERVER_STATE(function_hook_state_FopRead_END)
...
CARM95_WEBSERVER_STATE(function_hook_state_FopWrite_END)
...
CARM95_WEBSERVER_STATE(function_hook_state_FopWrite_FILE_INFO)
