...
static int(*original_FopRead_END)(br_datafile *, br_uint_32, br_uint_32, br_uint_32, ...) = (int(*)(br_datafile *, br_uint_32, br_uint_32, br_uint_32, ...))0x004e0a20;
...
static int(*original_FopWrite_END)(br_datafile *, ...) = (int(*)(br_datafile *, ...))0x004e0a30;
...
static int(*original_FopWrite_FILE_INFO)(br_datafile *, br_uint_32, ...) = (int(*)(br_datafile *, br_uint_32, ...))0x004e0a50;
