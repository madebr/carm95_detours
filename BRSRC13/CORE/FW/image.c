...
CARM95_WEBSERVER_STATE(BrImageAdd, function_hook_state_BrImageAdd)
...
CARM95_WEBSERVER_STATE(BrImageRemove, function_hook_state_BrImageRemove)
...
CARM95_WEBSERVER_STATE(BrImageFind, function_hook_state_BrImageFind)
...
CARM95_WEBSERVER_STATE(imageLoadHost, function_hook_state_imageLoadHost)
...
CARM95_WEBSERVER_STATE(BrImageReference, function_hook_state_BrImageReference)
...
CARM95_WEBSERVER_STATE(imageLookupName, function_hook_state_imageLookupName)
...
CARM95_WEBSERVER_STATE(BrImageLookupName, function_hook_state_BrImageLookupName)
...
CARM95_WEBSERVER_STATE(BrImageLookupOrdinal, function_hook_state_BrImageLookupOrdinal)
...
CARM95_WEBSERVER_STATE(BrImageDereference, function_hook_state_BrImageDereference)
...
CARM95_WEBSERVER_STATE(BrImageFree, function_hook_state_BrImageFree)
...
CARM95_WEBSERVER_STATE(_BrImageFree, function_hook_state__BrImageFree)
