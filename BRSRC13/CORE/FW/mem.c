...
CARM95_WEBSERVER_STATE(function_hook_state_BrMemAllocate)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrMemFree)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrMemInquire)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrMemAlign)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrMemCalloc)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrMemStrDup)
