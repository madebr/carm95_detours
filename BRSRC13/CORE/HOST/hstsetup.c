...
CARM95_WEBSERVER_STATE(HostBegin, function_hook_state_HostBegin)
...
CARM95_WEBSERVER_STATE(HostEnd, function_hook_state_HostEnd)
...
CARM95_WEBSERVER_STATE(HostInfo, function_hook_state_HostInfo)
