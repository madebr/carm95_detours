...
CARM95_WEBSERVER_STATE(BrStdioAttributes, function_hook_state_BrStdioAttributes)
...
CARM95_WEBSERVER_STATE(BrStdioOpenRead, function_hook_state_BrStdioOpenRead)
...
CARM95_WEBSERVER_STATE(BrStdioOpenWrite, function_hook_state_BrStdioOpenWrite)
...
CARM95_WEBSERVER_STATE(BrStdioClose, function_hook_state_BrStdioClose)
...
CARM95_WEBSERVER_STATE(BrStdioEof, function_hook_state_BrStdioEof)
...
CARM95_WEBSERVER_STATE(BrStdioGetChar, function_hook_state_BrStdioGetChar)
...
CARM95_WEBSERVER_STATE(BrStdioPutChar, function_hook_state_BrStdioPutChar)
...
CARM95_WEBSERVER_STATE(BrStdioRead, function_hook_state_BrStdioRead)
...
CARM95_WEBSERVER_STATE(BrStdioWrite, function_hook_state_BrStdioWrite)
...
CARM95_WEBSERVER_STATE(BrStdioGetLine, function_hook_state_BrStdioGetLine)
...
CARM95_WEBSERVER_STATE(BrStdioPutLine, function_hook_state_BrStdioPutLine)
...
CARM95_WEBSERVER_STATE(BrStdioAdvance, function_hook_state_BrStdioAdvance)
