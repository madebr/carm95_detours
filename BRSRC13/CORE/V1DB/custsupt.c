...
CARM95_WEBSERVER_STATE(function_hook_state_BrModelToScreenQuery)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrModelToViewQuery)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrOriginToScreenXY)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrOriginToScreenXYZO)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrPointToScreenXY)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrPointToScreenXYZO)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrPointToScreenXYMany)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrPointToScreenXYZOMany)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrZbDepthToScreenZ)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrZbScreenZToDepth)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrZsDepthToScreenZ)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrZsScreenZToDepth)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrScreenZToCamera)
...
CARM95_WEBSERVER_STATE(function_hook_state_BrScreenXYZToCamera)
