...
CARM95_WEBSERVER_STATE(BrMaterialUpdate, function_hook_state_BrMaterialUpdate)
...
CARM95_WEBSERVER_STATE(BrMaterialClear, function_hook_state_BrMaterialClear)
