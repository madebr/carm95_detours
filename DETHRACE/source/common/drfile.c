...
CARM95_WEBSERVER_STATE(DRStdioOpenRead, function_hook_state_DRStdioOpenRead)
...
CARM95_WEBSERVER_STATE(DRStdioOpenWrite, function_hook_state_DRStdioOpenWrite)
...
CARM95_WEBSERVER_STATE(DRStdioClose, function_hook_state_DRStdioClose)
...
CARM95_WEBSERVER_STATE(DRStdioRead, function_hook_state_DRStdioRead)
...
CARM95_WEBSERVER_STATE(DRStdioWrite, function_hook_state_DRStdioWrite)
...
CARM95_WEBSERVER_STATE(InstallDRFileCalls, function_hook_state_InstallDRFileCalls)
