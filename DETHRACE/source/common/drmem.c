...
CARM95_WEBSERVER_STATE(SetNonFatalAllocationErrors, function_hook_state_SetNonFatalAllocationErrors)
...
CARM95_WEBSERVER_STATE(ResetNonFatalAllocationErrors, function_hook_state_ResetNonFatalAllocationErrors)
...
CARM95_WEBSERVER_STATE(AllocationErrorsAreFatal, function_hook_state_AllocationErrorsAreFatal)
...
CARM95_WEBSERVER_STATE(MAMSInitMem, function_hook_state_MAMSInitMem)
...
CARM95_WEBSERVER_STATE(PrintMemoryDump, function_hook_state_PrintMemoryDump)
...
CARM95_WEBSERVER_STATE(DRStdlibAllocate, function_hook_state_DRStdlibAllocate)
...
CARM95_WEBSERVER_STATE(DRStdlibFree, function_hook_state_DRStdlibFree)
...
CARM95_WEBSERVER_STATE(DRStdlibInquire, function_hook_state_DRStdlibInquire)
...
CARM95_WEBSERVER_STATE(Claim4ByteAlignment, function_hook_state_Claim4ByteAlignment)
...
CARM95_WEBSERVER_STATE(InstallDRMemCalls, function_hook_state_InstallDRMemCalls)
...
CARM95_WEBSERVER_STATE(MAMSUnlock, function_hook_state_MAMSUnlock)
...
CARM95_WEBSERVER_STATE(MAMSLock, function_hook_state_MAMSLock)
...
CARM95_WEBSERVER_STATE(CreateStainlessClasses, function_hook_state_CreateStainlessClasses)
...
CARM95_WEBSERVER_STATE(CheckMemory, function_hook_state_CheckMemory)
