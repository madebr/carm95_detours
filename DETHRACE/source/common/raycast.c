...
static int(*original_DRActorToRoot)(br_actor *, br_actor *, br_matrix34 *, ...) = (int(*)(br_actor *, br_actor *, br_matrix34 *, ...))0x00494230;
...
static void(*original_InitRayCasting)() = (void(*)())0x004942e4;
...
static int(*original_PickBoundsTestRay__raycast)(br_bounds *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, br_scalar *, br_scalar *, ...) = (int(*)(br_bounds *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, br_scalar *, br_scalar *, ...))0x00494765;
...
static int(*original_ActorPick2D)(br_actor *, br_model *, br_material *, dr_pick2d_cbfn *, void *, ...) = (int(*)(br_actor *, br_model *, br_material *, dr_pick2d_cbfn *, void *, ...))0x004944de;
...
static int(*original_DRScenePick2DXY)(br_actor *, br_actor *, br_pixelmap *, int, int, dr_pick2d_cbfn *, void *, ...) = (int(*)(br_actor *, br_actor *, br_pixelmap *, int, int, dr_pick2d_cbfn *, void *, ...))0x004943a8;
...
static int(*original_DRScenePick2D)(br_actor *, br_actor *, dr_pick2d_cbfn *, void *, ...) = (int(*)(br_actor *, br_actor *, dr_pick2d_cbfn *, void *, ...))0x0049499e;
...
static int(*original_DRModelPick2D__raycast)(br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, dr_modelpick2d_cbfn *, void *, ...) = (int(*)(br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, dr_modelpick2d_cbfn *, void *, ...))0x00494b88;
...
static int(*original_FindHighestCallBack__raycast)(br_actor *, br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, void *, ...) = (int(*)(br_actor *, br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, void *, ...))0x00494b28;
...
static void(*original_FindBestY)(br_vector3 *, br_actor *, br_scalar, br_scalar *, br_scalar *, br_model **, br_model **, int *, int *, ...) = (void(*)(br_vector3 *, br_actor *, br_scalar, br_scalar *, br_scalar *, br_model **, br_model **, int *, int *, ...))0x00494a71;
...
static int(*original_FindYVerticallyBelowPolyCallBack)(br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, int, int, int, br_vector3 *, br_vector2 *, void *, ...) = (int(*)(br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, int, int, int, br_vector3 *, br_vector2 *, void *, ...))0x004955eb;
...
static int(*original_FindYVerticallyBelowCallBack)(br_actor *, br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, void *, ...) = (int(*)(br_actor *, br_model *, br_material *, br_vector3 *, br_vector3 *, br_scalar, br_scalar, void *, ...))0x0049558b;
...
static br_scalar(*original_FindYVerticallyBelow)(br_vector3 *, ...) = (br_scalar(*)(br_vector3 *, ...))0x004953da;
...
static br_scalar(*original_FindYVerticallyBelow2)(br_vector3 *, ...) = (br_scalar(*)(br_vector3 *, ...))0x0049564b;
