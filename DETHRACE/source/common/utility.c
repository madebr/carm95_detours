...
CARM95_WEBSERVER_STATE(CheckQuit, function_hook_state_CheckQuit)
...
CARM95_WEBSERVER_STATE(sqr, function_hook_state_sqr)
...
CARM95_WEBSERVER_STATE(EncodeLine, function_hook_state_EncodeLine)
...
CARM95_WEBSERVER_STATE(IRandomBetween, function_hook_state_IRandomBetween)
...
CARM95_WEBSERVER_STATE(PercentageChance, function_hook_state_PercentageChance)
...
CARM95_WEBSERVER_STATE(IRandomPosNeg, function_hook_state_IRandomPosNeg)
...
CARM95_WEBSERVER_STATE(FRandomBetween, function_hook_state_FRandomBetween)
...
CARM95_WEBSERVER_STATE(FRandomPosNeg, function_hook_state_FRandomPosNeg)
...
CARM95_WEBSERVER_STATE(SRandomBetween, function_hook_state_SRandomBetween)
...
CARM95_WEBSERVER_STATE(SRandomPosNeg, function_hook_state_SRandomPosNeg)
...
CARM95_WEBSERVER_STATE(GetALineWithNoPossibleService, function_hook_state_GetALineWithNoPossibleService)
...
CARM95_WEBSERVER_STATE(GetALineAndDontArgue, function_hook_state_GetALineAndDontArgue)
...
CARM95_WEBSERVER_STATE(PathCat, function_hook_state_PathCat)
...
CARM95_WEBSERVER_STATE(Chance, function_hook_state_Chance)
...
CARM95_WEBSERVER_STATE(tandeg, function_hook_state_tandeg)
...
CARM95_WEBSERVER_STATE(GetFileLength, function_hook_state_GetFileLength)
...
CARM95_WEBSERVER_STATE(BooleanTo1Or0, function_hook_state_BooleanTo1Or0)
...
CARM95_WEBSERVER_STATE(DRPixelmapAllocate, function_hook_state_DRPixelmapAllocate)
...
CARM95_WEBSERVER_STATE(DRPixelmapAllocateSub, function_hook_state_DRPixelmapAllocateSub)
...
CARM95_WEBSERVER_STATE(DRPixelmapMatchSized, function_hook_state_DRPixelmapMatchSized)
...
CARM95_WEBSERVER_STATE(CopyDoubled8BitTo16BitRectangle, function_hook_state_CopyDoubled8BitTo16BitRectangle)
...
CARM95_WEBSERVER_STATE(Scale8BitPixelmap, function_hook_state_Scale8BitPixelmap)
...
CARM95_WEBSERVER_STATE(Tile8BitPixelmap, function_hook_state_Tile8BitPixelmap)
...
CARM95_WEBSERVER_STATE(FindExceptionInList, function_hook_state_FindExceptionInList)
...
CARM95_WEBSERVER_STATE(PurifiedPixelmap, function_hook_state_PurifiedPixelmap)
...
CARM95_WEBSERVER_STATE(DRPixelmapLoad, function_hook_state_DRPixelmapLoad)
...
CARM95_WEBSERVER_STATE(DRPixelmapLoadMany, function_hook_state_DRPixelmapLoadMany)
...
CARM95_WEBSERVER_STATE(WaitFor, function_hook_state_WaitFor)
...
CARM95_WEBSERVER_STATE(DRActorEnumRecurse, function_hook_state_DRActorEnumRecurse)
...
CARM95_WEBSERVER_STATE(CompareActorID, function_hook_state_CompareActorID)
...
CARM95_WEBSERVER_STATE(DRActorFindRecurse, function_hook_state_DRActorFindRecurse)
...
CARM95_WEBSERVER_STATE(DRActorEnumRecurseWithMat, function_hook_state_DRActorEnumRecurseWithMat)
...
CARM95_WEBSERVER_STATE(DRActorEnumRecurseWithTrans, function_hook_state_DRActorEnumRecurseWithTrans)
...
CARM95_WEBSERVER_STATE(sign, function_hook_state_sign)
...
CARM95_WEBSERVER_STATE(fsign, function_hook_state_fsign)
...
CARM95_WEBSERVER_STATE(OpenUniqueFileB, function_hook_state_OpenUniqueFileB)
...
CARM95_WEBSERVER_STATE(PrintScreenFile, function_hook_state_PrintScreenFile)
...
CARM95_WEBSERVER_STATE(PrintScreenFile16, function_hook_state_PrintScreenFile16)
...
CARM95_WEBSERVER_STATE(PrintScreen, function_hook_state_PrintScreen)
...
CARM95_WEBSERVER_STATE(GetTotalTime, function_hook_state_GetTotalTime)
...
CARM95_WEBSERVER_STATE(GetRaceTime, function_hook_state_GetRaceTime)
...
CARM95_WEBSERVER_STATE(AddLostTime, function_hook_state_AddLostTime)
...
CARM95_WEBSERVER_STATE(TimerString, function_hook_state_TimerString)
...
CARM95_WEBSERVER_STATE(GetMiscString, function_hook_state_GetMiscString)
...
CARM95_WEBSERVER_STATE(GetCopyOfMiscString, function_hook_state_GetCopyOfMiscString)
...
CARM95_WEBSERVER_STATE(Flash, function_hook_state_Flash)
...
CARM95_WEBSERVER_STATE(MaterialCopy, function_hook_state_MaterialCopy)
...
CARM95_WEBSERVER_STATE(RGBDifferenceSqr, function_hook_state_RGBDifferenceSqr)
...
CARM95_WEBSERVER_STATE(FindBestMatch, function_hook_state_FindBestMatch)
...
CARM95_WEBSERVER_STATE(BuildShadeTablePath, function_hook_state_BuildShadeTablePath)
...
CARM95_WEBSERVER_STATE(LoadGeneratedShadeTable, function_hook_state_LoadGeneratedShadeTable)
...
CARM95_WEBSERVER_STATE(SaveGeneratedShadeTable, function_hook_state_SaveGeneratedShadeTable)
...
CARM95_WEBSERVER_STATE(GenerateShadeTable, function_hook_state_GenerateShadeTable)
...
CARM95_WEBSERVER_STATE(GenerateDarkenedShadeTable, function_hook_state_GenerateDarkenedShadeTable)
...
CARM95_WEBSERVER_STATE(PossibleService, function_hook_state_PossibleService)
...
CARM95_WEBSERVER_STATE(DRMatrix34TApplyP, function_hook_state_DRMatrix34TApplyP)
...
CARM95_WEBSERVER_STATE(PaletteEntry16Bit, function_hook_state_PaletteEntry16Bit)
...
CARM95_WEBSERVER_STATE(PaletteOf16Bits, function_hook_state_PaletteOf16Bits)
...
CARM95_WEBSERVER_STATE(Copy8BitTo16Bit, function_hook_state_Copy8BitTo16Bit)
...
CARM95_WEBSERVER_STATE(Copy8BitTo16BitRectangle, function_hook_state_Copy8BitTo16BitRectangle)
...
CARM95_WEBSERVER_STATE(Copy8BitTo16BitRectangleWithTransparency, function_hook_state_Copy8BitTo16BitRectangleWithTransparency)
...
CARM95_WEBSERVER_STATE(Copy8BitToOnscreen16BitRectangleWithTransparency, function_hook_state_Copy8BitToOnscreen16BitRectangleWithTransparency)
...
CARM95_WEBSERVER_STATE(Copy8BitRectangleTo16BitRhombusWithTransparency, function_hook_state_Copy8BitRectangleTo16BitRhombusWithTransparency)
...
CARM95_WEBSERVER_STATE(DRPixelmapRectangleCopy, function_hook_state_DRPixelmapRectangleCopy)
...
CARM95_WEBSERVER_STATE(DRPixelmapCopy, function_hook_state_DRPixelmapCopy)
...
CARM95_WEBSERVER_STATE(DRPixelmapRectangleFill, function_hook_state_DRPixelmapRectangleFill)
...
CARM95_WEBSERVER_STATE(NormalSideOfPlane, function_hook_state_NormalSideOfPlane)
...
CARM95_WEBSERVER_STATE(DRMaterialClone, function_hook_state_DRMaterialClone)
...
CARM95_WEBSERVER_STATE(StripCR, function_hook_state_StripCR)
...
CARM95_WEBSERVER_STATE(SubsStringJob, function_hook_state_SubsStringJob)
...
CARM95_WEBSERVER_STATE(DecodeLine2, function_hook_state_DecodeLine2)
...
CARM95_WEBSERVER_STATE(EncodeLine2, function_hook_state_EncodeLine2)
...
CARM95_WEBSERVER_STATE(EncodeFile, function_hook_state_EncodeFile)
...
CARM95_WEBSERVER_STATE(EncodeFileWrapper, function_hook_state_EncodeFileWrapper)
...
CARM95_WEBSERVER_STATE(EncodeAllFilesInDirectory, function_hook_state_EncodeAllFilesInDirectory)
...
CARM95_WEBSERVER_STATE(SkipNLines, function_hook_state_SkipNLines)
...
CARM95_WEBSERVER_STATE(DRStricmp, function_hook_state_DRStricmp)
...
CARM95_WEBSERVER_STATE(GlorifyMaterial, function_hook_state_GlorifyMaterial)
...
CARM95_WEBSERVER_STATE(WhitenVertexRGB, function_hook_state_WhitenVertexRGB)
...
CARM95_WEBSERVER_STATE(NobbleNonzeroBlacks, function_hook_state_NobbleNonzeroBlacks)
...
CARM95_WEBSERVER_STATE(PDCheckDriveExists, function_hook_state_PDCheckDriveExists)
...
CARM95_WEBSERVER_STATE(OpacityInPrims, function_hook_state_OpacityInPrims)
...
CARM95_WEBSERVER_STATE(AlreadyBlended, function_hook_state_AlreadyBlended)
...
CARM95_WEBSERVER_STATE(BlendifyMaterialTablishly, function_hook_state_BlendifyMaterialTablishly)
...
CARM95_WEBSERVER_STATE(BlendifyMaterialPrimitively, function_hook_state_BlendifyMaterialPrimitively)
...
CARM95_WEBSERVER_STATE(BlendifyMaterial, function_hook_state_BlendifyMaterial)
